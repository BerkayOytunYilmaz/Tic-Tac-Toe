...
IL_0035:
	...
	{
		// if (cfxrEffect != null) cfxrEffect.clearBehavior = CFXR_Effect.ClearBehavior.Disable;
		CFXR_Effect_t3017EDCEABB0C70663A82AAA961EE597C0AF743A* L_18 = V_3;
		NullCheck(L_18);
		L_18->___clearBehavior_7 = 1;
	}
...
IL_0070:
	...
	}
	{
		...
		L_25 = List_1_ToArray_m9237E7439BAF0FDCFB325D21398E459BEDB3432C(L_24, List_1_ToArray_m9237E7439BAF0FDCFB325D21398E459BEDB3432C_RuntimeMethod_var);
		__this->___effectsList_28 = L_25;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___effectsList_28), (void*)L_25);
		// PlayAtIndex();
		CFXR_Demo_PlayAtIndex_m9015D10CB7D122067A50B951740F04A5B9BC1112(__this, NULL);
		// UpdateLabels();
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CFXR_Demo_Update_m9A55C3BA95AAE759CC901A345356ADCC54E71DCD (CFXR_Demo_tC798392D488F2E202DFEB3464B0A5EFEC019BE6C* __this, const RuntimeMethod* method) 
{
	...
	bool V_5 = false;
	bool V_6 = false;
	CFXR_EffectU5BU5D_t77DDA5EBA474FE690699DFECA868F462EFED87CD* V_7 = NULL;
	CFXR_EffectU5BU5D_t77DDA5EBA474FE690699DFECA868F462EFED87CD* V_8 = NULL;
	int32_t V_9 = 0;
	CFXR_Effect_t3017EDCEABB0C70663A82AAA961EE597C0AF743A* V_10 = NULL;
	bool V_11 = false;
	bool V_12 = false;
	bool V_13 = false;
	bool V_14 = false;
	...
	}
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_2 = __this->___demoCamera_20;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_3;
		L_3 = Vector3_get_zero_m0C1249C3F25B1C70EAD3CC8B31259975A457AE39_inline(NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_4;
		L_4 = Vector3_get_up_m128AF3FDC820BF59D5DE86D973E7DE3F20C3AEBA_inline(NULL);
		float L_5 = __this->___rotationSpeed_22;
		float L_6;
		L_6 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		NullCheck(L_2);
		Transform_RotateAround_m489C5BE8B8B15D0A5F4863DE6D23FF2CC8FA76C6(L_2, L_3, L_4, ((float)il2cpp_codegen_multiply(L_5, L_6)), NULL);
	}
...
IL_002f:
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_12 = __this->___currentEffect_27;
		NullCheck(L_12);
		...
		NullCheck(L_14);
		bool L_15;
		L_15 = ParticleSystem_get_isEmitting_mE3EC701A8C5DACA27FDA91D8956CCE1ABAC6A0D9(L_14, NULL);
		V_5 = L_15;
		bool L_16 = V_5;
		if (!L_16)
		{
	...
	}
	{
		...
		NullCheck(L_17);
		ParticleSystem_Stop_m6CA855033D5CE2D3AF7927B6709BC65DBCD632DF(L_17, (bool)1, NULL);
		goto IL_00e6;
	}
...
IL_0079:
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_18 = __this->___currentEffect_27;
		NullCheck(L_18);
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_22 = __this->___currentEffect_27;
		NullCheck(L_22);
...
IL_00a4:
	{
		...
		NullCheck(L_23);
		ParticleSystem_Play_m4A59E0A2C7CA49EF75287A067305ABB314A16E62(L_23, (bool)1, NULL);
		// var cfxrEffects = currentEffect.GetComponentsInChildren<CFXR_Effect>();
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_24 = __this->___currentEffect_27;
		NullCheck(L_24);
		CFXR_EffectU5BU5D_t77DDA5EBA474FE690699DFECA868F462EFED87CD* L_25;
		L_25 = GameObject_GetComponentsInChildren_TisCFXR_Effect_t3017EDCEABB0C70663A82AAA961EE597C0AF743A_m7298B4F90C049C78FED0FA41A2610C8268480135(L_24, GameObject_GetComponentsInChildren_TisCFXR_Effect_t3017EDCEABB0C70663A82AAA961EE597C0AF743A_m7298B4F90C049C78FED0FA41A2610C8268480135_RuntimeMethod_var);
		V_7 = L_25;
		// foreach (var cfxr in cfxrEffects)
		CFXR_EffectU5BU5D_t77DDA5EBA474FE690699DFECA868F462EFED87CD* L_26 = V_7;
		V_8 = L_26;
		V_9 = 0;
		goto IL_00dc;
	}
...
IL_00c5:
	{
		// foreach (var cfxr in cfxrEffects)
		CFXR_EffectU5BU5D_t77DDA5EBA474FE690699DFECA868F462EFED87CD* L_27 = V_8;
		int32_t L_28 = V_9;
		NullCheck(L_27);
		int32_t L_29 = L_28;
		CFXR_Effect_t3017EDCEABB0C70663A82AAA961EE597C0AF743A* L_30 = (L_27)->GetAt(static_cast<il2cpp_array_size_t>(L_29));
		V_10 = L_30;
		// cfxr.ResetState();
		CFXR_Effect_t3017EDCEABB0C70663A82AAA961EE597C0AF743A* L_31 = V_10;
		NullCheck(L_31);
		CFXR_Effect_ResetState_m610E43E011438C9B8496202AC20150A8A296C1FF(L_31, NULL);
		int32_t L_32 = V_9;
...
IL_00dc:
	{
		// foreach (var cfxr in cfxrEffects)
		int32_t L_33 = V_9;
		CFXR_EffectU5BU5D_t77DDA5EBA474FE690699DFECA868F462EFED87CD* L_34 = V_8;
		NullCheck(L_34);
...
IL_00e8:
	{
		...
		bool L_35;
		L_35 = Input_GetKeyDown_mB237DEA6244132670D38990BAB77D813FBB028D2(((int32_t)127), NULL);
		if (L_35)
		{
			goto IL_00f9;
		}
	...
	{
		bool L_36;
		L_36 = Input_GetKeyDown_mB237DEA6244132670D38990BAB77D813FBB028D2(8, NULL);
...
IL_00fa:
	...
	{
		// if (currentEffect != null)
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_38 = __this->___currentEffect_27;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_39;
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_41 = __this->___currentEffect_27;
		NullCheck(L_41);
...
IL_0162:
	...
	}
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_49 = __this->___demoCamera_20;
		NullCheck(L_49);
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_50;
		L_50 = Component_GetComponent_TisCamera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184_m64AC6C06DD93C5FB249091FEC84FA8475457CCC4(L_49, Component_GetComponent_TisCamera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184_m64AC6C06DD93C5FB249091FEC84FA8475457CCC4_RuntimeMethod_var);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_51;
		L_51 = Input_get_mousePosition_mFF21FBD2647DAE2A23BD4C45571CA95D05A0A42C(NULL);
		NullCheck(L_50);
		Ray_t2B1742D7958DC05BDC3EFC7461D3593E1430DC00 L_52;
		L_52 = Camera_ScreenPointToRay_m2887B9A49880B7AB670C57D66B67D6A6689FE315(L_50, L_51, NULL);
		V_16 = L_52;
		// if (Physics.Raycast(ray))
		Ray_t2B1742D7958DC05BDC3EFC7461D3593E1430DC00 L_53 = V_16;
		bool L_54;
		L_54 = Physics_Raycast_mDB89EB287ED040E534F6A933683A070D29DC14D3(L_53, NULL);
		V_17 = L_54;
		bool L_55 = V_17;
		if (!L_55)
		{
	...
	{
		// if (currentEffect != null)
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_56 = __this->___currentEffect_27;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_57;
	...
	{
		// currentEffect.SetActive(false);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_59 = __this->___currentEffect_27;
		NullCheck(L_59);
		GameObject_SetActive_m638E92E1E75E519E5B24CF150B08CA8E0CDFAB92(L_59, (bool)0, NULL);
		// currentEffect.SetActive(true);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_60 = __this->___currentEffect_27;
		NullCheck(L_60);
...
IL_01c4:
	{
		...
		bool L_61;
		L_61 = Input_GetMouseButtonDown_m8DFC792D15FFF15D311614D5CC6C5D055E5A1DE3(1, NULL);
		if (L_61)
		{
			goto IL_01d4;
		}
	...
	{
		bool L_62;
		L_62 = Input_GetMouseButtonDown_m8DFC792D15FFF15D311614D5CC6C5D055E5A1DE3(2, NULL);
		G_B35_0 = ((int32_t)(L_62));
		goto IL_01d5;
	}
...
IL_01e4:
	{
		...
		float L_64;
		L_64 = Input_GetAxis_m10372E6C5FF591668D2DC5F58C58D213CC598A62(_stringLiteralFC6687DC37346CD2569888E29764F727FAF530E0, NULL);
		V_0 = L_64;
		// if (scroll != 0f)
		float L_65 = V_0;
		V_20 = (bool)((((int32_t)((((float)L_65) == ((float)(0.0f)))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		bool L_66 = V_20;
		if (!L_66)
		{
			goto IL_023c;
...
IL_0224:
	{
		...
		L_71 = Vector3_op_Multiply_m87BA7C578F96C8E49BB07088DAAC4649F83B0353_inline(G_B41_1, G_B41_0, NULL);
		float L_72 = __this->___zoomFactor_23;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_73;
		L_73 = Vector3_op_Multiply_m87BA7C578F96C8E49BB07088DAAC4649F83B0353_inline(L_71, L_72, NULL);
		NullCheck(G_B41_2);
		Transform_Translate_m4A9E3D8836586E7562F6A18EBF5F5B6089D8B649(G_B41_2, L_73, 1, NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CFXR_Demo_PlayAtIndex_m9015D10CB7D122067A50B951740F04A5B9BC1112 (CFXR_Demo_tC798392D488F2E202DFEB3464B0A5EFEC019BE6C* __this, const RuntimeMethod* method) 
{
	...
	{
		// currentEffect.SetActive(false);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_3 = __this->___currentEffect_27;
		NullCheck(L_3);
...
IL_0020:
	{
		...
		GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_4 = __this->___effectsList_28;
		int32_t L_5 = __this->___index_29;
		NullCheck(L_4);
		int32_t L_6 = L_5;
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_7 = (L_4)->GetAt(static_cast<il2cpp_array_size_t>(L_6));
		__this->___currentEffect_27 = L_7;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___currentEffect_27), (void*)L_7);
		// currentEffect.SetActive(true);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_8 = __this->___currentEffect_27;
		NullCheck(L_8);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CFXR_Demo_WrapIndex_m82B44BE735AEBAE58FC762F9638EDCD5F86CD648 (CFXR_Demo_tC798392D488F2E202DFEB3464B0A5EFEC019BE6C* __this, const RuntimeMethod* method) 
{
	...
	{
		// if (index < 0) index = effectsList.Length - 1;
		GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_2 = __this->___effectsList_28;
		NullCheck(L_2);
		__this->___index_29 = ((int32_t)il2cpp_codegen_subtract(((int32_t)(((RuntimeArray*)L_2)->max_length)), 1));
	}

IL_001e:
	{
		// if (index >= effectsList.Length) index = 0;
		int32_t L_3 = __this->___index_29;
		GameObjectU5BU5D_tFF67550DFCE87096D7A3734EA15B75896B2722CF* L_4 = __this->___effectsList_28;
		NullCheck(L_4);
		V_1 = (bool)((((int32_t)((((int32_t)L_3) < ((int32_t)((int32_t)(((RuntimeArray*)L_4)->max_length))))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		bool L_5 = V_1;
		if (!L_5)
		{
			goto IL_003c;
...
{
	{
		...
		__this->___slowMotion_24 = (bool)0;
		// bool rotateCamera = false;
		__this->___rotateCamera_25 = (bool)0;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CFXR_Demo_Translate_Awake_m2E13757C3B4901D3D03E45F0EC35D92B2262E23F (CFXR_Demo_Translate_t95CB6CDBAE93F397B9CA608E9B233BAB8C7FB891* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___initialPosition_7 = L_3;
	}
